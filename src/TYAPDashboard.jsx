...
import { Fingerprint, Wallet, History, CreditCard, Zap, Home, User as UserIcon, ArrowRight, ArrowDown, ArrowUp } from 'lucide-react';

export default function TYAPPassengerApp() {
        ...
        <div className="flex space-x-2 mb-6 bg-gray-100 p-1 rounded-lg">
          {['home', 'history', 'profile'].map((tab) => (
            ...
            >
              ...
              {tab === 'profile' && <UserIcon size={16} className="inline mr-1" />}
              {tab}
            </button>
          ))}
        </div>
